...
-- List 2 This list includes the manager's employee number, 
-- first name, last name, and their starting and ending employment dates
...
-- List 3: We'll use inner joins on the current_emp, departments,
